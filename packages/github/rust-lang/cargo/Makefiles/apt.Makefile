...
CC = cargo
CFLAGS = 
DEPENDENCIES = python3 git build-essential cc make cmake gcc g++ ninja rustc cargo curl pkg-config libiconv libssl-dev libstdc++-static libcurl libgit2 libssh2 zlib
...
build-all: setup
	...
	@cd ${PKG_NAME}; ${CC} ${CFLAGS} build --release && \
